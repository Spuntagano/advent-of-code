...
const run = (grid, startPosition, endPosition, stepCount) => {
    buildBestGrid();
    const queue = [{
        x: startPosition.x,
        y: startPosition.y,
...
const a = run(grid, startPosition, endPosition, 0);
const b = run(calculateNewGrid(null, a), endPosition, startPosition, a);
const c = run(calculateNewGrid(null, b), startPosition, endPosition, b);
console.log(c);
