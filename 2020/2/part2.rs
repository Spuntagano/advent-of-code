...
fn main() -> std::io::Result<()> {
    ...
    for line in lines {
        ...
        let minimum_value = split_values[0].parse::<usize>().unwrap();
        let maximum_value = split_values[1].parse::<usize>().unwrap();
        ...
        if (password_characters[minimum_value - 1] == character) ^ (password_characters[maximum_value - 1] == character) {
